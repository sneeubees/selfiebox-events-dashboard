      ...
      <div className="app-shell">
        ...
        <header className="topbar compact">
          <div className="topbar-brand">
            <span className="topbar-logo" role="img" aria-label="SelfieBox"><span className="topbar-logo-selfie">Selfie</span><span className="topbar-logo-box">Box</span><span className="topbar-logo-spark" aria-hidden="true">✦</span></span>
